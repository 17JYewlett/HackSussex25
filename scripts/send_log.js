...
async function logDriverScore() {
    ...
    try {
		...
		const brakeScore = document.getElementById("brakeScore").value;
        ...
        const tx = await contract.functionNAME(walletAddress, finalKey, carReg, safetyScore, brakeScore, speedScore, reasoning="");  
